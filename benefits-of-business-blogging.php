...
<html>
    ...
    <div class="row padding-5">
        ...
        <h1 class="page-header center">What are the benefits of business blogging?</h1>
            ...
            <div class="row justify" style="font-size: 16px">
                ...
                <p class="blog-text">
                <h2>Does business blogging work?</h2>
                <br/>
                ...
                <p class="blog-text">
	                <h2>This is how one niche recruitment agency used blogging to boost candidate applications.</h2>
									<br/>
                ...
                After three months the project had been a resounding success. Our goal had been to attract one good quality candidate per quarter (roughly equivalent to the results that were being achieved through advertising on one of the top job sites) and we achieved more than one a month. As a result we are continuing with the campaign and over time we are seeing even more impressive results. If you would like to read more examples of how content marketing works in different industries please get in touch. 
								...
								<p class="blog-text">
									<h2>How to make sure you get ROI on content marketing spend</h2>
									<br/>
									...
									<br/>
									<h3>Be known for what you do</h3>
									<br/>
									...
									<br/>
									<h2>How much time and money should you spend on content marketing</h2>
									Costs vary hugely from agency to agency. At The Content Market our fees are at the lower end of the scale and are similar to those charged by independent copywriters. That doesn't mean we're not as good as the big agencies, it just means we keep our costs low. We specialise in content writing and marketing and we don't try to provide a complete agency service. The main thing that affects your costs is the frequency of your business blogging. We recommend doing it at least once a week but if you can do it two - or even three - times a week, so much the better. Some of our clients even ask us to blog daily for them.
									<br/>
